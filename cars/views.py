...
def cars(request):
    ...
    data = {'cars': paged_cars,'model_search': model_search,'city_search': city_search,
...
def search(request):
    ...
    data = {'cars': cars,'model_search': model_search,'city_search': city_search,'year_search': year_search,
